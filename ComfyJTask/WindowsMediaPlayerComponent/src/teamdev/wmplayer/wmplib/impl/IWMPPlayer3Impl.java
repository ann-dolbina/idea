...
/**
 * Represents COM interface IWMPPlayer3.
 */
public class IWMPPlayer3Impl extends IWMPCore2Impl
        implements IWMPPlayer3 {
    public static final String INTERFACE_IDENTIFIER = IWMPPlayer3.INTERFACE_IDENTIFIER;
    private static final IID _iid = IID.create(INTERFACE_IDENTIFIER);

    public IWMPPlayer3Impl() {
    }

    protected IWMPPlayer3Impl(IUnknownImpl that) throws ComException {
        super(that);
    }

    public IWMPPlayer3Impl(IUnknown that) throws ComException {
        super(that);
    }

    public IWMPPlayer3Impl(CLSID clsid, ClsCtx dwClsContext) throws ComException {
        super(clsid, dwClsContext);
    }

    public IWMPPlayer3Impl(CLSID clsid, IUnknownImpl pUnkOuter, ClsCtx dwClsContext) throws ComException {
    ...
    public Object clone() {
        return new IWMPPlayer3Impl(this);
    }
}
