...
/**
 * Represents COM interface IWMPPlayer.
 */
public class IWMPPlayerImpl extends IWMPCoreImpl
        implements IWMPPlayer {
    public static final String INTERFACE_IDENTIFIER = IWMPPlayer.INTERFACE_IDENTIFIER;
    private static final IID _iid = IID.create(INTERFACE_IDENTIFIER);

    public IWMPPlayerImpl() {
    }

    protected IWMPPlayerImpl(IUnknownImpl that) throws ComException {
        super(that);
    }

    public IWMPPlayerImpl(IUnknown that) throws ComException {
        super(that);
    }

    public IWMPPlayerImpl(CLSID clsid, ClsCtx dwClsContext) throws ComException {
        super(clsid, dwClsContext);
    }

    public IWMPPlayerImpl(CLSID clsid, IUnknownImpl pUnkOuter, ClsCtx dwClsContext) throws ComException {
    ...
    public Object clone() {
        return new IWMPPlayerImpl(this);
    }
}
